 ...
 */
export function crearTareaConDatos(nombre, descripcion, dificultad, estado, fechaVencimiento) {
...
export function editarTarea(indice, arrTareas) {
    let entrada = "";
    let tempFecha;
    ...
    if (entrada === " ") {
        ...
        arrTareas[indice - 1].setDificultad(parseInt(entrada));
    }
